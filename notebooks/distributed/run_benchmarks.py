...
srun -ul --environment=/iopsstor/scratch/cscs/boeschf/pytorch-training/notebooks/distributed/edf.toml python main.py --method {method} --epochs 5 --batch_size 256
"""
